 ...
 * 指向未完成状态：status 说明它现在是什么状态，progress 是粗到不能再粗的完成
 * 度，works / blocked 分开写「还能跑的部分」和「卡住的地方」。
 *
 * works 和 blocked 拆成两个数组，是因为一段自由文本很容易写成一段含糊的辩解；
 * 拆成条目之后，写不出来就说明这个实验没什么可记的。
 */
